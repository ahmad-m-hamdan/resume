        ...
        <section className="mb-24">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-12 hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-gray-700">
                  <i className="fa-solid fa-angle-right text-indigo-500 shrink-0" aria-hidden="true"></i>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-12">
              ...
              <div className="flex flex-wrap gap-3">
                {["HTML5", "CSS3", "LESS/SASS", "Bootstrap", "jQuery", "AJAX", "Foundation", "Tailwind CSS", "JavaScript (ES6)", "React.js", "WCAG"].map((skill) => (
                  <span
                    key={skill}
                    className="px-4 py-2 bg-linear-to-r from-blue-50 to-blue-100 text-blue-700 text-sm font-semibold rounded-lg border border-blue-200 hover:shadow-md transition-shadow"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-12">
              ...
              <div className="flex flex-wrap gap-3">
                {["PHP", "Yii2", "Fat-Free", "CodeIgniter", "MySQL", "MariaDB", "SQL"].map((skill) => (
                  <span
                    key={skill}
                    className="px-4 py-2 bg-linear-to-r from-purple-50 to-purple-100 text-purple-700 text-sm font-semibold rounded-lg border border-purple-200 hover:shadow-md transition-shadow"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-12">
              ...
              <div className="flex flex-wrap gap-3">
                {["CI/CD", "Git", "GitHub", "GitLab", "Bitbucket", "Confluence", "Jira", "Composer", "npm", "PHPUnit"].map((skill) => (
                  <span
                    key={skill}
                    className="px-4 py-2 bg-linear-to-r from-indigo-50 to-indigo-100 text-indigo-700 text-sm font-semibold rounded-lg border border-indigo-200 hover:shadow-md transition-shadow"
                  >
                    {skill}
                  </span>
                ))}
